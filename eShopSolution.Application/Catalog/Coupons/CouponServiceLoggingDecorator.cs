...
{
    public class CouponServiceLoggingDecorator : ICouponService
    {
        private readonly EShopDbContext _context;
        private readonly ICouponService _couponService;
        private readonly ILogger<CouponServiceLoggingDecorator> _logger;

        public CouponServiceLoggingDecorator(ICouponService couponService,
            ILogger<CouponServiceLoggingDecorator> logger, EShopDbContext context)
        {
            _logger = logger;
            _context = context;
        ...
        public async Task<PagedResult<CouponViewModel>> GetAllPaging(GetManageProductPagingRequest request)
        {
            ...
            {
                _logger.LogInformation("Coupon: " + coupon.Id + ", Name: " + coupon.Describe, "Code: " + coupon.Code);
            }
